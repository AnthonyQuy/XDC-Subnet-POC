...
const MemberDetails = ({ member, isManager, onRemoveMember, onUpdateStatus }) => {
  ...
  const handleStatusChange = () => {
    if (window.confirm(`Are you sure you want to set this member to ${member.isActive ? 'inactive' : 'active'}?`)) {
